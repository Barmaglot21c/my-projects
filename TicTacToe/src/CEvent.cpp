...
void CEvent::OnEvent(SDL_Event* Event) {
    switch(Event->type) {
        ...
        case SDL_KEYDOWN: {
            OnKeyDown(Event->key.keysym.sym,Event->key.keysym.mod); // был +юникод ,Event->key.keysym.unicode
            break;
        }
 
        case SDL_KEYUP: {
            OnKeyUp(Event->key.keysym.sym,Event->key.keysym.mod); // был +юникод ,Event->key.keysym.unicode
            break;
        }
